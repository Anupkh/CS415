...
/**
 * The partial version only connects to a client and sends a response to a single
 * message that comes from a client. 
 * @author CS415
 * You will need to 
 * 1. handle multiple strings
 * 2. call getResponse on the mock Chatbot and use that response in the outputstream		
